...
var Util = /** @class */ (function () {
    function Util() {
        ...
        this.endpoint = 'https://my-json-server.typicode.com/fadilxcoder/fake-api-server/users/';
        this.obj = {};
        this.clickAndFind();
    }
    Util.prototype.clickAndFind = function () {
        var thisObj = this;
        $(document).on('click', '#submitIdentifier', function (e) {
            thisObj._generateRandomInt();
            var id = Number($('#identifier').val());
            thisObj.findOne(id).then(function (response) {
                thisObj.map(response);
            });
        });
    };
    Util.prototype._generateRandomInt = function () {
        var value = (Math.floor(Math.random() * 11) == 0) ? 1 : Math.floor(Math.random() * 11);
        $("#identifier").attr('value', value);
    };
    Util.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, data, status_1, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, axios_1["default"].get(this.endpoint + id, {
                                headers: {
                    ...
                    case 1:
                        ...
                        console.log('HTTP CODE ' + status_1);
                        return [2 /*return*/, {
                                id: data.id,
